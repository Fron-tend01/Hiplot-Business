...
const LoginForm: React.FC = () => {
  ...
  const bis_data: any = sessionStorage.getItem('bis_data');
      ...
      <div className='loginForm'>
        ...
        <div className='rigth'>
          {state ? (
            ...
            <>
              <form className='form' onSubmit={handleLogin} autoComplete="on" method="POST" action="/login" >
                <div className='container__form'>
                  <div className='title__form'>
                    <div>
                      <h3 className='title__procura'>
                        <p className='hisoft'>
                          <b><b className='hi'>Hi</b><b className='soft'>So</b><b className='ft'>ft</b><b className='business'>Business</b></b>
                        </p>
                      </h3>
                  ...
                  <div className='inputs__form'>
                    ...
                    <div className={`container__inputs ${focusField === 'user' ? 'focused' : ''}`}>
                      ...
                      <datalist id="user-suggestions">
                        {userSuggestions?.map((user: any, index: number) => (
                  ...
                  <div className='inputs__form'>
                    ...
                    <div className={`container__inputs ${focusField === 'password' ? 'focused' : ''}`}>
                      ...
                      <button type="button" className='toggle-password-btn' onClick={handleTogglePassword}>
                        {showPassword ? (
                          <svg className='see__password' width="18" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
