...
const Combinations = () => {
  ...
  return (
    <div className={`overlay__create_modal_combinations_articles ${subModal == 'update_modal_combinations' ? 'active' : ''}`}>
        <div className={`popup__create_modal_combinations_articles ${subModal == 'update_modal_combinations' ? 'active' : ''}`}>
