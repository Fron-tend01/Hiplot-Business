    ...
    return (
        <div className={`overlay__create_modal_clients ${modal == 'create_clients' || modal == 'update_clients' ? 'active' : ''}`}>
            <div className={`popup__create_modal_clients ${modal == 'create_clients' || modal == 'update_clients' ? 'active' : ''}`}>
                ...
                <br />
                <hr />
                <small><b>INFORMACIÓN GENERAL</b></small>
                <hr />
                <form className='' onSubmit={handleCreateClients}>
                    <div className='row align-txt-left'>
                        ...
                        <div className='col-5 md-col-5 sm-col-12'>
                        ...
                        <div className='col-1 md-col-1 sm-col-12' title='Activo / Inactivo'>
                            <small >Status</small>
                            <div className='warning__general'><small>Este campo es obligatorio</small></div>
                    ...
                    <br />
                    <hr />
                    <small><b>INFORMACIÓN FISCAL</b></small>
                    <hr />
                    <div className='row align-txt-left'>
                        <div className='col-4 md-col-6 sm-col-12'>
                    ...
                    <div className='row'>
                        ...
                        <div className='col-12 md-col-12 sm-col-12'>
                            <small>Este botón habilitará el cliente a tus diferentes sucursales</small><br />

                            <button type='button' className='btn__general-orange' onClick={() => setModalSub('modal-sub_create_clients')}>Habilitar a Sucursales</button>
                        </div>
                    </div>
