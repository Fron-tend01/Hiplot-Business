  ...
  return (
    <div className='series'>
      <div className='series__container'>
        ...
        <div className={`overlay__update_branch-offices ${modalStateUpdate ? 'active' : ''}`}>
          <div className={`popup__update_branch-offices ${modalStateUpdate ? 'active' : ''}`}>
            <a href="#" className="btn-cerrar-popup__update_branch-offices" onClick={modalCloseUpdate}>
              <svg className='svg__close' xmlns="http://www.w3.org/2000/svg" height="16" width="12" viewBox="0 0 384 512"><path d="M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z"/></svg>
            </a>
            <p className='title__modals'>Actualizar serie</p>
            <form className='conatiner__create_series' onSubmit={handleUpdateSeries}>
            <div className='select__container'>
                <label className='label__general'>Empresas</label>
                <div className='select-btn__general'>
                  <div className={`select-btn ${selectCompanies ? 'active' : ''}`} onClick={openSelectCompanies}>
              ...
              <div className='container__series_btn_modal_container'>
                <button className='btn__general-purple' type='submit'>Actualiar serie</button>
              </div>
            </form>
          </div>
        </div>
