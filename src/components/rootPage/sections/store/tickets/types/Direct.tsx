...
//////////////////////////////////Directa////////////////////////////////////////////////
    ...
    const addArticles = () => {
        ...
        let unidad = selectedModalResult.unidades[0].id
        let suppliers = selectedModalResult.proveedores;
        let id_proveedor = selectedModalResult.proveedores[0].id
        let id_almacen = null

        setConceptos([...conceptos, { id_proveedor, suppliers, id_articulo, units, cantidad: null, restante: 0, unidad, id_almacen, comentarios: '' }]);
