...
const Direct: React.FC = () => {
  ...
  const [selectedSearchBy, setSelectedSearchBy] = useState<any>(2)
    ...
    <div className='direct-warehouse-exit'>
      <div className='row__one'>
        ...
        <div className="comments">
          ...
          <input className='inputs__general' type='text' value={inputSearch} onChange={(e) => setInputSearch(e.target.value)}
            onKeyUp={(event) => event.key === 'Enter' && search()} placeholder='Ingresa el código/nombre' />
        </div>
        <div>
